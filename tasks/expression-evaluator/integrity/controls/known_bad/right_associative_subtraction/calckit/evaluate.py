...
class _Parser:
    ...
    def parse_expression(self):
        ...
        # BUG: recurses on the remainder instead of looping/left-folding, so
        # chained +/- fold from the right: "10-2-3" becomes 10-(2-3).
    ...
    def parse_term(self):
        # term := factor (('*' | '/') term)?
        # Same right-folding bug for */: "8/2/2" becomes 8/(2/2).
