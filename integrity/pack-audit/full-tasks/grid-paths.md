...
**Timestamp**: 2026-09-18T07:16:07.723450+00:00  
**Duration**: 60752 ms
...
| `mutation.generic_ast_mutants` | mutation | PASS | info | All 22 relevant mutant(s) were killed by the hidden suite (kill_rate=1.00 over 22 generated, 0 unsupported, 0 declared-equivalent, 0 intercepted by the regression/scope gate before reaching the hidden suite). |
...
- `task_id`: grid-paths
- `task_version`: 1.0.1
- `task_json_hash`: sha256:d1809ce45d05b71411ca263c438e1197300660e57664f7006a2579a097663549
...
- `grading_hash`: sha256:01dc6a3e9f475f53944070131cf2aea02d8adb598b142cc4ddf3fea26522bd77
- `controls_hash`: None
