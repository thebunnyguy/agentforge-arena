...
**Timestamp**: 2026-09-18T07:15:28.293773+00:00  
**Duration**: 106583 ms
...
| `noop.unmodified_baseline` | negative_control | PASS | info | The unmodified snapshot passes regression, fails the hidden suite (T_hidden=0.400), and scores 0.0 / functional_pass=False, as required. |
...
| `wrong_exception_type` | known_bad | reject | rejected_by_hidden_test | PASS | verdict=rejected_by_hidden_test; failing_hidden_tests=['test_dotdot_escape_raises', 'test_absolute_component_raises', 'test_absolute_component_raises_even_when_it_reads_as_inside_base', 'test_deep_dotdot_escape_raises', 'test_prefix_collision_sibling_raises'] |
...
- `task_version`: 1.0.2
- `task_json_hash`: sha256:31029bde5a9951365b098086caf27df9a93d73acce2eb9776b9fdf2bbc25939b
...
- `grading_hash`: sha256:e0f6522d93ec2e9199c9fdb3e3254e0126f81432c50ff9a7ea412d9768e47d11
