...
**Timestamp**: 2026-09-18T07:17:02.817007+00:00  
**Duration**: 109611 ms
...
| `mutation.generic_ast_mutants` | mutation | PASS | info | All 22 relevant mutant(s) were killed by the hidden suite (kill_rate=1.00 over 23 generated, 0 unsupported, 1 declared-equivalent, 0 intercepted by the regression/scope gate before reaching the hidden suite). |
...
|---|---|---|---|---|---|
| `first_dependency_only` | known_bad | reject | rejected_by_hidden_test | PASS | verdict=rejected_by_hidden_test; failing_hidden_tests=['test_multiple_implicit_dependencies'] |
...
- `task_id`: toposort
- `task_version`: 1.0.2
- `task_json_hash`: sha256:01a6cebaf8a210b514c8692fac7abaa9be0a99818791046c7923344c37e1f7ac
...
- `grading_hash`: sha256:6e4f427f9a456e158918b22935cbacdd96b7c396f73ccd30dae1882ec312ac70
