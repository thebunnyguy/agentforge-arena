...
**Timestamp**: 2026-09-17T21:16:31.352738+00:00  
**Duration**: 54115 ms
...
| `hidden_import_closure.gate7` | isolation | PASS | info | At most one distinct local file (['abatch/__init__.py']) is reachable by a diff without failing the scope gate and imported by the hidden/regression suites — unambiguously the code under test, not a separate oracle-helper module. |
...
|---|---|---|---|
| `abatch/batch.py` | 14 | boundary_operator | boundary_operator: batch_size <= 0 (LtE -> Lt) |
...
- `task_id`: async-batched
- `task_version`: 1.0.2
- `task_json_hash`: sha256:f87fdfc0ca7694d7268ae203f866cf2e04c8088532bbf5783be6ac0a3bc427e3
- `snapshot_hash`: sha256:13c980075962a4a39633dc7b123969730887b205bbcd8b168ab5717597261e3b
- `reference_hash`: sha256:ef99d8205a2df40255d10b15c546a366a22859ac22c1274724dffd6bb56cae93
- `grading_hash`: sha256:4901ad37dae27369d69e364fa32a646d33cd19bbfa36fdbf0ae1b1222ca51acd
- `controls_hash`: None
