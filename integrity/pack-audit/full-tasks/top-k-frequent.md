...
**Timestamp**: 2026-09-18T07:16:58.893646+00:00  
**Duration**: 48814 ms
...
| `mutation.generic_ast_mutants` | mutation | PASS | info | All 12 relevant mutant(s) were killed by the hidden suite (kill_rate=1.00 over 13 generated, 0 unsupported, 1 declared-equivalent, 0 intercepted by the regression/scope gate before reaching the hidden suite). |
...
- `task_version`: 1.0.3
- `task_json_hash`: sha256:22fccffe81359f113e7312304337e2c44cfcf6f15410c82d9b536da10001f9a0
...
- `grading_hash`: sha256:1885fd83b8ffa749f88ef88518e3b86bc8ed8b63647cce495179a7bf09f50e27
- `controls_hash`: None
