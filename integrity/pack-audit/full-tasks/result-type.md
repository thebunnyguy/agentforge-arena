...
**Timestamp**: 2026-09-17T20:41:48.846264+00:00  
**Duration**: 52103 ms
...
| `mutation.generic_ast_mutants` | mutation | PASS | info | All 19 relevant mutant(s) were killed (kill_rate=1.00 over 19 generated, 0 unsupported, 0 declared-equivalent). |
...
- `task_id`: result-type
- `task_version`: 1.0.1
- `task_json_hash`: sha256:06d694bc78f271c676f408ee546db6baba423aa0e2b86512c876dd16b919db4e
...
- `grading_hash`: sha256:4a7a3faa61818d0fc13f51dda4bfba89e7dc5bb85c1179f3625d9d09a7e6b8c4
- `controls_hash`: None
