...
**Timestamp**: 2026-09-17T20:40:45.115178+00:00  
**Duration**: 385324 ms  
**Tasks audited**: 24
...
| `fix-path-traversal` | 1.0.1 | NEEDS_REVIEW | mutation.generic_ast_mutants: 2/15 relevant mutant(s) survived (kill_rate=0.87 over 15 relevant of 15 generated). A surviving mutant is n... |
| `fix-roman-numerals` | 1.0.0 | NEEDS_REVIEW | mutation.generic_ast_mutants: 1/27 relevant mutant(s) survived (kill_rate=0.96 over 27 relevant of 27 generated). A surviving mutant is n... |
...
| `merge-intervals` | 1.0.1 | NEEDS_REVIEW | mutation.generic_ast_mutants: 3/17 relevant mutant(s) survived (kill_rate=0.82 over 17 relevant of 17 generated). A surviving mutant is n... |
...
| `refactor-order-validation` | 1.0.2 | NEEDS_REVIEW | mutation.generic_ast_mutants: 4/40 relevant mutant(s) survived (kill_rate=0.90 over 40 relevant of 40 generated). A surviving mutant is n... |
